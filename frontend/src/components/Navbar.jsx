  ...
  return (
    <nav className="navbar">
      ...
      <div className="navbar-links">
        ...
        <NavLink to="/recommendations" className={({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>Weekly Picks</NavLink>
      </div>
      ...
      <div className="navbar-auth">
        {isLoggedIn ? (
          ...
          <div className="auth-buttons">
            <a href={`${API}/auth/steam`} className="steam-login-btn" title="Sign in through Steam">
              <SteamIcon />
              <span>Sign in</span>
            </a>
            {googleEnabled && (
              <a href={`${API}/auth/google`} className="google-login-btn" title="Sign in with Google">
                <GoogleIcon />
                <span>Sign in</span>
              </a>
            )}
